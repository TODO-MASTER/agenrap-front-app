...
export default function ProfessionalDeleteWkpDialog({
  open,
  setOpen,
  weekLabel,
  pending,
      ...
      >
        ...
        <div className="flex flex-col items-center gap-y-4 px-8 pb-8">
          <p className="font-tree text-white text-center text-lg">
            ...
            <span className="text-red-600 font-bold">{weekLabel}</span>?
          </p>

          <div className="flex gap-x-3 w-full">
            <AgenrapButton className="w-full" onClick={() => setOpen(false)}>
              Voltar
            </AgenrapButton>
            <AgenrapButton
