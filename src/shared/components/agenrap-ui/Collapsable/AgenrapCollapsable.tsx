...
import { IAgenrapCollapsableProps } from "./types/IAgenrapCollapsableProps";
import { useState } from "react";
export default function AgenrapCollapsable({ children, collapseName, spawnNotifier }: IAgenrapCollapsableProps) {
