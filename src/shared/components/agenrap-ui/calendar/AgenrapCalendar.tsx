...
export default function AgenrapCalendar({business,date,setDate,className,fullDays,setFullDays }: CalendarContext) {
        const { handleSaveAppointment, isSaveAppointmentPending, isStartBookedDaysTransition,handleMonthChange } = useCustomerActions()
    ...
    // "data-[outside=true]:text-black w-full",
    //             ),
                selected: cn(
