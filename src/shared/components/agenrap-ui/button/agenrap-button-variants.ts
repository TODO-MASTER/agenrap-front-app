...
export const agenrapButtonVariants = cva(
    ...
    , {
        variants: {
            variant: {
                purplerap: "w-full h-[100px] outline-none text-white bg-(--agenrap-purple-500) hover:opacity-90 cursor-pointer font-figtree font-medium text-2xl rounded-md",
                ...
                pictureHangerRap:"border-4 font-tree  border-(--agenrap-yellow-200)/85 rounded-xs bg-(--agenrap-pure-white)  justify-center flex flex-col gap-2 items-center rounded-md",
