...
import { CollapsableOccupationItemSimpleProps } from "../../../interfaces/business/CollapsableOccupationItemProps";
export default function CardServiceFit({ name, duration, value}: CollapsableOccupationItemSimpleProps) {
    return (
