...
export default function CardDayWeek({ form, index, remove, mode = 'edit', showTimeFields = true }: ICardDayWeeksProps) {
        ...
        <div className="flex flex-col w-full bg-(--agenrap-gray-800) rounded-md overflow-hidden border-l-4 border-(--agenrap-yellow-200)">
            ...
            {!showTimeFields ? (
                <div className="px-4 pb-4">
                    <p className="text-white/40 text-xs font-tree">Horário definido pelo dono</p>
                </div>
            ) : isShow ? (
