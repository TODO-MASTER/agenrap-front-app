import { IBusinessCardProps } from "@/src/shared/interfaces/business/IBusinessCardProps";

export default function CardBusiness({ name, init, end, qtdService }: IBusinessCardProps) {
    return (
