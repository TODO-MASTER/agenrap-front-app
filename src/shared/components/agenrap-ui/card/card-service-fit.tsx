...
export default function CardServiceFit({ name, duration, value,actionButton}: CollapsableServiceItemSimpleProps) {
    return (
        <div className=" flex flex-col w-full  rounded-md overflow-hidden  pl-3 gap-y-1 relative bg-(--agenrap-gray-800)">
            ...
            <div className="flex justify-end self-end w-full p-4 pt-4 py-0 pr-0 pb-0 h-full  rounded-tl-[4.40rem]  rounded-br-md bg-(--agenrap-yellow-200) ">
