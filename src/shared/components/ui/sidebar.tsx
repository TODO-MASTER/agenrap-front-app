...
import { ArrowLeft, ArrowLeftSquareIcon, ArrowRightFromLine, ArrowRightIcon, ArrowRightSquareIcon, PaintbrushVertical, PanelLeftClose, PanelLeftIcon, PanelLeftOpen, PanelRightClose } from "lucide-react"
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("hover:bg-transparent rounded-none flex justify-center items-center   h-full", className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
      {...props}
    >
    {open?<PanelLeftClose  className="[&_svg]:size-6"/>:<ArrowRightFromLine size={6} className=" " />}  
