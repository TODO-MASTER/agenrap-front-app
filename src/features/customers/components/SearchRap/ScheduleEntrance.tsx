...
import AgenrapNfmInput from "@/src/shared/components/agenrap-ui/input/AgenrapNfmInput"
import { IBusinessCtx } from "@/src/shared/types/Business/IBusinessCtx"
import { CarIcon, HandPlatter, LoaderCircle, ServerIcon } from "lucide-react"
...
export default function ScheduleEntrance() {
    ...
    const [searchBsn, setSearchBsn] = useState<IBusinessCtx | null | 'not-init'>('not-init')
